...
=======
        tw`border-0 rounded-md cursor-pointer flex-row px-2.5 py-2.5 bg-primary-200 width[36px] height[36px] flex justify-center items-center mx-1 font-sans hover:bg-hover-light dark:hover:bg-hover-dark`,
