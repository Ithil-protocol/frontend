...
export const fixedYieldAddress = {
  98745: "0x42767fe00c3283553cC42D0609BF56b3A5a5b63e",
} as const;
...
>(
  config: Omit<
    ...
    "abi" | "address"
  > & { chainId?: keyof typeof fixedYieldAddress } = {} as any
) {
...
export function useFixedYieldWrite<
  ...
  TChainId extends number = keyof typeof fixedYieldAddress
>(
 ...
 *
 */
export function useFixedYieldClose<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof fixedYieldAddress
>(
  config: TMode extends "prepared"
 ...
 *
 */
export function useFixedYieldEdit<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof fixedYieldAddress
>(
  config: TMode extends "prepared"
 ...
 *
 */
export function useFixedYieldOpen<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof fixedYieldAddress
>(
  config: TMode extends "prepared"
