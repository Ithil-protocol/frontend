...
export const managerAddress = {
  98745: "0x123f3Ebe26C9FfcE201C981E4c0D0f60B1E53755",
} as const;
...
>(
  config: Omit<
    ...
    "abi" | "address"
  > & { chainId?: keyof typeof managerAddress } = {} as any
) {
  return useContractRead({
    abi: managerABI,
    address: managerAddress[98745],
    ...config,
...
export function useManagerWrite<
  ...
  TChainId extends number = keyof typeof managerAddress
>(
 ...
 *
 */
export function useManagerBorrow<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof managerAddress
>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        ...
        "borrow",
        TMode
      > & { address?: Address; chainId?: TChainId; functionName?: "borrow" }
 ...
 *
 */
export function useManagerRepay<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof managerAddress
>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        ...
        "repay",
        TMode
      > & { address?: Address; chainId?: TChainId; functionName?: "repay" }
 ...
 *
 */
export function useManagerSetCap<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof managerAddress
>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        ...
        "setCap",
        TMode
      > & { address?: Address; chainId?: TChainId; functionName?: "setCap" }
 ...
 *
 */
export function useManagerSweep<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof managerAddress
>(
  config: TMode extends "prepared"
